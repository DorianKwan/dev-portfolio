...
export const workHistoryData: WorkHistoryEntry[] = [
  ...
  },
  {
    ...
    bullets: [
      '**Founded engineering stack and standards for a greenfield team**: tech stack, app architecture, branching strategy, commit standards, PR workflows, app layer boundaries, and automated code quality enforcement.',
  ...
  },
  {
    key: 'launchcode',
    company: 'Launchcode',
    role: 'Full Stack Software Engineer - Hybrid',
  ...
  },
  {
    ...
    role: '(Senior) Web Developer - Remote',
